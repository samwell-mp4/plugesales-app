...
type Role = 'ADMIN' | 'EMPLOYEE' | 'CLIENT' | 'PENDING_CLIENT' | 'INFLUENCER' | 'ASSINATURA_BASICA' | 'usuario_forum' | 'VENDEDOR' | 'CONTABILIDADE' | 'COZINHEIRA';
...
const VALID_USERS = [
    ...
    { name: 'Bernado Rodrigues', role: 'EMPLOYEE' as Role, password: 'Plugsales2026' },
    ...
    { name: 'Andre Maia', role: 'EMPLOYEE' as Role, password: 'Plugsales2026' },
