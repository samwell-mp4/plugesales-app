...
const articleBlocks: Record<string, ArticleData> = {
  'op-contatos': {
    ...
    blocks: [
      { id: 'b1', type: 'paragraph', content: { html: 'Para que um cliente possa acessar a plataforma e criar suas campanhas, primeiro ele precisa ser cadastrado. O processo é simples: o colaborador gera um <strong>link de convite</strong> com validade de 24 horas e envia para o cliente via WhatsApp, e-mail ou qualquer outro canal.' } },
      { id: 'b2', type: 'heading', content: { text: 'Passo a Passo' } },
      { id: 'b3', type: 'steps', content: { items: [
        'Acesse o menu <strong>Upload Clientes</strong> no painel lateral esquerdo.',
        'Clique no botão <strong>GERAR NOVO CLIENTE</strong> no topo da página.',
        'O sistema gera um link único (<code>https://plugesales.com/news-clients/{codigo}</code>) e <strong>copia automaticamente</strong> para a área de transferência.',
        'Cole o link no WhatsApp, e-mail ou outro canal e envie para o cliente.',
        'O cliente abre o link e preenche o cadastro em <strong>2 etapas</strong>: dados pessoais e contato.',
        'Após enviar, o cadastro fica <strong>Em Análise</strong> — um administrador precisa aprovar manualmente.',
      ] } },
      { id: 'b4', type: 'image', content: { caption: 'Print: Botão GERAR NOVO CLIENTE no topo da página' } },
      { id: 'b5', type: 'alert', content: { variant: 'info', title: 'Validade do Link', text: 'O link gerado tem validade de <strong>24 horas</strong>. Se expirar antes do cliente se cadastrar, basta gerar um novo clicando novamente em "GERAR NOVO CLIENTE".' } },
      { id: 'b6', type: 'divider', content: {} },
      { id: 'b7', type: 'heading', content: { text: 'Após a Aprovação' } },
      { id: 'b8', type: 'paragraph', content: { html: 'Depois que o administrador aprova o cadastro, o cliente recebe acesso à plataforma. Ele pode fazer login e acessar o <strong>Client Dashboard</strong> em <code>/client-dashboard</code>, onde pode criar campanhas via <strong>Client External Form</strong> e acompanhar os resultados dos disparos.' } },
      { id: 'b9', type: 'alert', content: { variant: 'warning', title: 'Conta Bloqueada', text: 'A conta do cliente fica com status <code>WAITING_APPROVAL</code> (bloqueada) até que um administrador aprove manualmente. Enquanto isso, o cliente não consegue fazer login.' } },
    ],
  },
  'op-contas-monitor': {
    ...
    categoryId: 'operacional',
    blocks: [
      { id: 'b1', type: 'paragraph', content: { html: 'O <strong>Monitor de WhatsApp</strong> é o ponto de partida para qualquer operação no Plug & Sales. Nesta página, você configura a conexão com a Meta (através da Infobip) e monitora o status de aprovação dos seus templates em tempo real.' } },
      ...
      { id: 'b5', type: 'list', content: { items: [
        '<strong>API Key</strong>: Chave de autenticação fornecida pelo portal Infobip.',
      ...
      { id: 'b13', type: 'steps', content: { items: [
        'Acesse a aba <strong>Contas & Monitor</strong> no sidebar.',
      ...
      { id: 'b14', type: 'image', content: { caption: 'Print: Tela Contas & Monitor com tabela de templates' } },
