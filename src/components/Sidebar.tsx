    ...
    const menuData = [
        {
            ...
            items: [
                ...
                { name: 'Gerar Em Lote', path: '/template-batch', icon: <Layers />, roles: ['ADMIN', 'EMPLOYEE'] },
        ...
        },
        {
            ...
            items: [
                ...
                { name: 'Relatórios (Entregas)', path: '/dispatch-reports', icon: <FileSpreadsheet />, roles: ['ADMIN', 'EMPLOYEE', 'VENDEDOR', 'CONTABILIDADE'] },
            ...
            : user?.role === 'ASSINATURA_BASICA'
                ...
                : user?.role === 'CONTABILIDADE'
                    ? [
                        ...
                        { icon: <Layers />, path: '/finance/collaborators-hub' }
                    ]
                    : [
