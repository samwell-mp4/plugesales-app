...
const initialPosts = [
    ...
    },
    {
        ...
        excerpt: 'Descubra como um chatbot inteligente no WhatsApp reduz custos em até 70%, aumenta conversão em 5x e escala seu atendimento 24/7 com IA.',
        category: 'Tecnologia',
        author: 'Time Plug & Sales',
        date: '01 Mai, 2026',
        readTime: '8 min',
    ...
    },
    {
        ...
        title: 'Como Integrar CRM com WhatsApp: Guia Completo para Centralizar sua Comunicação',
        excerpt: 'Guia completo sobre integração de CRM com WhatsApp via API Oficial. Aprenda a automatizar follow-ups, centralizar comunicações e nunca mais perder um lead.',
        category: 'Vendas',
