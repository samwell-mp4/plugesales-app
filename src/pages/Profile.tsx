                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', gap: '32px' }}>
                            ...
                            <div className="crm-card" style={{ padding: '32px' }}>
                                <h2 style={{ margin: '0 0 24px 0', fontSize: '1.25rem', fontWeight: 900, display: 'flex', alignItems: 'center', gap: '10px' }}>
                                    <Clock size={20} color="var(--primary-color)" /> Solicitações de Adiantamento Pendentes
                                </h2>
                                        ...
                                        <table className="crm-table" style={{ width: '100%' }}>
                                            <thead>
                                                <tr style={{ borderBottom: '1px solid var(--surface-border-subtle)' }}>
                                                    ...
                                                    <th style={{ padding: '12px', textAlign: 'right', fontSize: '11px', color: 'var(--text-muted)' }}>SOLICITADO</th>
                                                    <th style={{ padding: '12px', textAlign: 'right', fontSize: '11px', color: 'var(--text-muted)' }}>SALDO DISPONÍVEL</th>
                                                    <th style={{ padding: '12px', textAlign: 'left', fontSize: '11px', color: 'var(--text-muted)' }}>CHAVE PIX</th>
                                                    <th style={{ padding: '12px', textAlign: 'center', fontSize: '11px', color: 'var(--text-muted)' }}>AÇÕES</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                    ...
                                                    <tr key={req.id} style={{ borderBottom: '1px solid var(--surface-border-subtle)' }}>
                                                        ...
                                                        <td style={{ padding: '12px', textAlign: 'center' }}>
                                                            <div style={{ display: 'flex', gap: '8px', justifyContent: 'center' }}>
                                                                <button 
                                                                    onClick={() => handleRespondRequest(req.id, 'Aprovado')}
                                                                    className="action-btn primary-btn"
